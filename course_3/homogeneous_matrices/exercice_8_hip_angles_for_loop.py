...
def visualiser_le_c3d(c3d_filename: str, numero_marqueur: int = None, usecols: list = None):
    """ afficher les marqueurs 3D """
    if usecols is not None:
        markers_from_c3d = Markers.from_c3d(c3d_filename, usecols=usecols)
    else:
...
# decommenter pour voir les marqueurs animés
visualiser_le_c3d(c3d_filename, usecols=["R_IAS","L_IAS","R_IPS","L_IPS","R_FME","R_FLE"])
