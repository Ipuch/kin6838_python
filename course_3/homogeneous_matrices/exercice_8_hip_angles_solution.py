...
markers = Markers.from_c3d(c3d_filename,usecols=["R_IAS","L_IAS","R_IPS","L_IPS","R_FME","R_FLE"])
...
display_frames_and_points(combined_markers, 
                          pelvis_tuple=(pelvis_x_axis, pelvis_y_axis, pelvis_z_axis, pelvis_origin),
                          femur_tuple=(femur_x_axis, femur_y_axis, femur_z_axis, femur_origin),
                          )


print("Pelvis Frame:",  (pelvis_x_axis, pelvis_y_axis, pelvis_z_axis, pelvis_origin))
print("Hip joint centers in global:", (right_hip_joint_center, left_hip_joint_center) )
print("Femur Frame:",  (femur_x_axis, femur_y_axis, femur_z_axis, femur_origin))
...
angles = rotation_matrix_to_euler_angles(R12, "zxy") 

print("Euler Angles:", angles * 180 / np.pi, "in degrees")
